...
export default function CoursesManagement() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      requestFormData.append("content", formData.content.trim());
      ...
      console.log("Course request form data:");
                  ...
                  <div className="space-y-3">
                    ...
                    {imagePreview && (
                      <div className="relative w-32 h-32">
                        <img
                          src={imagePreview.startsWith('/uploads') ? `${API_BASE}${imagePreview}` : imagePreview}
                          alt="Preview"
